...
const messages = {
  en: {
    ...
    welcomeEyebrow: 'Your animation workspace', welcomeTitle: 'Turn Live2D motions into desktop pets.', welcomeBody: 'Import once, preview every motion, map the behaviors you want, and export a ready-to-install theme.', importSource: 'Import Source Package', openProject: 'Open project', sampleProject: 'Open design preview', recent: 'Recent projects', noRecent: 'Your recent projects will appear here.',
    ...
    motions: 'Motion & Expression', preview: 'Live2D Preview', assignment: 'Assignment', motionsHint: 'Choose an animation to preview and assign.', previewHint: 'Your selected motion appears here.', assignmentHint: 'Apply the selected motion directly to a pet behavior.', selected: 'Selected', play: 'Play motion', assigned: 'Assigned behaviors', assign: 'Assign selected motion',
    sourceTitle: 'Source Package', sourceBody: 'Review model compatibility, included motions, expressions, and textures before mapping.', sourceReady: 'Ready for mapping', buildTitle: 'Package Build', buildBody: 'Review target readiness and generate installable Codex Pet and Clawd theme packages.', ready: 'Ready', buildTheme: 'Build theme',
    ...
    designPreview: 'Interface preview', notConnected: 'Desktop services unavailable', loading: 'Loading…', error: 'Something went wrong', retry: 'Try again',
  ...
  'zh-CN': {
    ...
    welcomeEyebrow: '你的动画工作区', welcomeTitle: '把 Live2D 动作变成桌面宠物。', welcomeBody: '导入资源、逐个预览动作、关联想要的行为，然后直接导出可安装的主题。', importSource: '导入资源包', openProject: '打开项目', sampleProject: '打开设计预览', recent: '最近项目', noRecent: '打开过的项目会显示在这里。',
    source: '资源', map: '映射', build: '构建', settings: '设置', close: '完成', project: 'Saint Louis · 预览项目', saved: '所有更改均已保存在本地',
    motions: '动作与表情', preview: 'Live2D 预览', assignment: '目标配置', motionsHint: '选择一个动画进行预览和配置。', previewHint: '当前选择的动作会显示在这里。', assignmentHint: '把左侧选择的动作直接关联到宠物行为。', selected: '已选择', play: '播放动作', assigned: '已关联行为', assign: '关联当前动作',
    sourceTitle: '资源包', sourceBody: '在开始映射前检查模型兼容性以及包含的动作、表情和纹理。', sourceReady: '可以开始映射', buildTitle: '主题构建', buildBody: '检查目标配置并生成可安装的 Codex Pet 与 Clawd 主题包。', ready: '已就绪', buildTheme: '构建主题',
    ...
    designPreview: '界面预览', notConnected: '桌面服务不可用', loading: '正在加载…', error: '出现问题', retry: '重试',
