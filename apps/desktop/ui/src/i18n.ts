...
const messages = {
  en: {
    ...
    welcomeEyebrow: 'Your animation workspace', welcomeTitle: 'Turn Live2D motions into desktop pets.', welcomeBody: 'Import once, preview every Motion, confirm the Motion Mapping, and build a ready-to-install Pet Package.', importSource: 'Import Source Package', importFolder: 'Live2D folder', importPck: 'Destiny Child PCK', importHint: 'Choose or drop a model folder or supported PCK file.', dropSource: 'Drop a Live2D folder or PCK to import', sourcePathUnavailable: 'Live2Pet could not read the selected local path.', openProject: 'Open project', sampleProject: 'Open design preview', recent: 'Recent projects', noRecent: 'Your recent projects will appear here.', petPackage: 'Pet Package', clawdPackage: 'Clawd Theme Package', codexPackage: 'Codex Pet Package',
