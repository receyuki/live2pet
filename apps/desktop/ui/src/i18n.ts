...
const messages = {
  ...
  'zh-CN': {
    ...
    welcomeEyebrow: '你的动画工作区', welcomeTitle: '把 Live2D 动作变成桌面宠物。', welcomeBody: '导入一次，逐个预览动作，确认动作映射，然后构建可直接安装的宠物包。', importSource: '导入资源包', openProject: '打开项目', sampleProject: '打开设计预览', recent: '最近项目', noRecent: '打开过的项目会显示在这里。', petPackage: '宠物包', clawdPackage: 'Clawd 主题包', codexPackage: 'Codex 宠物包',
