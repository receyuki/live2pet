...
const messages = {
  en: {
    ...
    sourceTitle: 'Source Package', sourceBody: 'Review model compatibility, included motions, expressions, and textures before mapping.', sourceReady: 'Ready for mapping', sourceModel: 'Model', sourceTextures: 'Textures', sourceMotions: 'Motions', sourceExpressions: 'Expressions', buildTitle: 'Package Build', buildBody: 'Review target readiness and generate installable Codex Pet and Clawd theme packages.', ready: 'Ready', buildTheme: 'Build theme', buildPackage: 'Build Pet Package',
  ...
  'zh-CN': {
    ...
    sourceTitle: '资源包', sourceBody: '在开始映射前检查模型兼容性以及包含的动作、表情和纹理。', sourceReady: '可以开始映射', sourceModel: '模型', sourceTextures: '纹理', sourceMotions: '动作', sourceExpressions: '表情', buildTitle: '包构建', buildBody: '检查目标配置并生成可安装的 Codex Pet 与 Clawd 宠物包。', ready: '已就绪', buildTheme: '构建主题', buildPackage: '构建宠物包',
