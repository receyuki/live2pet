...
const messages = {
  en: {
    ...
    setupRuntime: 'Runtime library', setupEmpty: 'No runtimes saved yet', setupSkip: 'Set up later', setupContinue: 'Continue to Live2Pet', addRuntime: 'Add runtime', addRuntimeFolder: 'Choose SDK folder', replaceRuntime: 'Add or replace', removeAll: 'Remove all', dropRuntime: 'Drop a runtime file or SDK folder here', dropOne: 'Drop one file or folder at a time.',
  ...
  'zh-CN': {
    ...
    setupRuntime: '运行时资源库', setupEmpty: '尚未保存运行时', setupSkip: '稍后设置', setupContinue: '进入 Live2Pet', addRuntime: '添加运行时', addRuntimeFolder: '选择 SDK 文件夹', replaceRuntime: '添加或替换', removeAll: '全部移除', dropRuntime: '将运行时文件或 SDK 文件夹拖到这里', dropOne: '每次只能拖入一个文件或文件夹。',
